...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
    Relational database is the place the data is stored. SQL is the code that is used to interact with that data.
- [ ] Why do tables need a `primary key`?
  A primary key is the unique identifier of the data.

- [ ] What is the name given to a table column that references the primary key on another table.
It is called a foreign key

- [ ] What do we need in order to have a _many to many_ relationship between two tables.
need another table that holds all the foreign keys that relate to the primary key.
